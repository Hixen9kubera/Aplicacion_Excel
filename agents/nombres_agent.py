...
def _extraer_chunk(lineas: list[str]) -> list[dict]:
    ...
    prompt = (
        ...
        "SIEMPRE en español. MUY IMPORTANTE: quita el color del nombre aunque esté al final. "
        "Dos productos del mismo tipo con distinto color DEBEN tener el MISMO nombre_base.\n"
        "  Ej: 'Termo 32oz negro'  → nombre_base:'Termo 32oz'          (quita 'negro')\n"
        "  Ej: 'Termo 32oz rosa'   → nombre_base:'Termo 32oz'          (MISMO que el negro)\n"
        "  Ej: 'Sudadera azul M'   → nombre_base:'Sudadera'            (quita color y talla)\n"
        "  Ej: 'Pantalón negro'    → nombre_base:'Pantalón'            (quita 'negro')\n"
        "  Ej: 'Silla de madera'   → nombre_base:'Silla'               (quita material)\n"
        "  Ej: 'Mochila#1'         → nombre_base:'Mochila'             (quita sufijo #N)\n\n"
        ...
        "EJEMPLOS OBLIGATORIOS (nombre_base | color | talla):\n"
        "  'Termo 32oz negro'                                    → base:'Termo 32oz',           color:'Negro',  talla:null\n"
        "  'Termo 32oz rosa'                                     → base:'Termo 32oz',           color:'Rosa',   talla:null\n"
        "  'Sudadera negra S'                                    → base:'Sudadera',             color:'Negro',  talla:'S'\n"
        "  'Estuche de maquillaje [original: 化妆包黑色]'         → base:'Estuche de maquillaje',color:'Negro',  talla:null\n"
        "  'Estuche de maquillaje [original: 化妆包粉色]'         → base:'Estuche de maquillaje',color:'Rosa',   talla:null\n"
        "  'Chaleco negro 3XL'                                   → base:'Chaleco',              color:'Negro',  talla:'3XL'\n"
        "  'Camiseta talla L'                                    → base:'Camiseta',             color:null,     talla:'L'\n"
        "  'Silla de madera'                                     → base:'Silla',                color:null,     talla:null\n\n"
...
_ATTR_VALIDOS = (
    ...
    "XS,S,M,L,XL,XXL,3XL,UNI,MAD,MET,TEL,CUE,EST,PRE,ECO,INF,ADU"
)
